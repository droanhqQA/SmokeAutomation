...
public class AddingConnector {
	...
	public void navigatetoConnector()
	{
		...
		new WebDriverWait(driver, max_time)
		.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#console-sidebar > div.sidebar-options > div.console-option.single-option.go-to-apis > div > div.option-data > div.option-name")));
		driver.findElement(By.cssSelector("#console-sidebar > div.sidebar-options > div.console-option.single-option.go-to-apis > div > div.option-data > div.option-name")).click();
	...
	String connectorDetails_details(int sheet_no,String save) throws IOException
	{
		...
		new WebDriverWait(driver, min_time).until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(add))));
		...
		new WebDriverWait(driver, min_time).until(ExpectedConditions.elementToBeClickable(By.cssSelector(path)));
		...
		new WebDriverWait(driver, min_time).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='categoryName'][@class='form-control mt-2']")));
...
//		driver.findElement(By.id("connectionstring")).sendKeys("mongodb+srv://fj:deltecs123@cluster0.z03w2.mongodb.net/sample_airbnb?retryWrites=true&w=majority");
		...
		WebDriverWait wait1 = new WebDriverWait(driver, min_time);
	...
	String connectorDetails_string(int sheet_no,String save) throws IOException
	{
		...
		String add = "body > div.console-body.pusher > div.header.main > div.header-region > div.header-functions.smaller-font-size > div.add-new-btn.add-category-button";
		new WebDriverWait(driver, 120).until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(add))));
		driver.findElement(By.cssSelector(add)).click();
	...
	public String connectorDetails_sheets(int sheet_no) throws IOException
	{
		...
		new WebDriverWait(driver, min_time).until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(add))));
		driver.findElement(By.cssSelector(add)).click();
		String sheet_connector ="//div[text()='Google Sheets']/parent::div";
		
		new WebDriverWait(driver,min_time).until(ExpectedConditions.presenceOfElementLocated(By.xpath(sheet_connector)));
		...
		driver.findElement(By.xpath("//*[contains(text(),'Sign in with Google')]")).click();//sign-in with google
		...
		driver.findElement(By.xpath("//input[@type='email']")).sendKeys("dronahq123@gmail.com");
		...
		WebElement button = driver.findElement(By.xpath("//*[contains(@class,'VfPpkd-vQzf8d')]"));
        JavascriptExecutor js = (JavascriptExecutor)driver;		
		js.executeScript("arguments[0].click();", button);

		driver.findElement(By.xpath("//*[@id='password']/div[1]/div/div[1]/input")).sendKeys("Qwerty@33");
		try {
			Thread.sleep(20000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
...
//		js.executeScript("window.scrollBy(0,250)", "");
	...
	public String connectorDetails_api(int sheet_no,String save)
	{
		...
		if(save.contains("add"))
		{
			...
			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", add_api);
		...
		String add = "body > div.console-body.pusher > div.header.main > div.header-region > div.header-functions.smaller-font-size > div.add-new-btn.add-category-button";
		new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(add))));
		driver.findElement(By.cssSelector(add)).click();
//		new WebDriverWait(driver, 20)
//		.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//div[@data-scheme_type='api_connector']"))));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", 	driver.findElement(By.xpath("//div[@data-scheme_type='api_connector']")));
		driver.findElement(By.xpath("//div[@data-scheme_type='api_connector']")).click();
		new WebDriverWait(driver, 20)
		...
		driver.findElement(By.xpath("//div[@data-value='api_key'][@class='item']")).click();
	...
	public String connectorDetails_graphql(int sheet_no,String save)
	{
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", 	driver.findElement(By.xpath("//div[@data-scheme_type='graphql']")));//scroll
		driver.findElement(By.xpath("//div[@data-scheme_type='graphql']")).click();
		driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
	...
	String saveConnection(WebDriver driver)
	{
		...
		new WebDriverWait(driver,Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath(save))));
	...
	public void gotoRestApi(WebDriver driver)
	{
		navigatetoConnector();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(60));
		driver.findElement(By.xpath("//*[@class='add-new-btn add-category-button']")).click();
